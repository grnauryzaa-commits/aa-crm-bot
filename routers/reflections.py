...
MORNING_PRAYER_TEXT_RU = (
    ...
    "<i>«Боже, направь мои помыслы в верное русло, убереги меня от жалости к"
    " себе, бесчестных поступков, корыстолюбия».</i>\n\n"
    "2. Утром, надо <b>подумать о предстоящем дне.</b>\n\n"
    "3. Размышляя о предстоящем дне... Если есть неуверенность, -"
    " <b>молитва:</b>\n"
    "<i>«Боже, дай мне вдохновение, интуитивные мысли или решения».</i>\n\n"
    "4. <b>Погружаемся в медитацию.</b>\n"
    "<i>«Боже, открой, каким должен быть мой следующий шаг, и дай мне всё, что"
    " необходимо для решения моих проблем. Освободи меня от своєволия».</i>\n\n"
...
EVENING_PRAYER_TEXT_RU = (
    ...
    "<i>Затем мы прощаем всех, а свои ошибки вручаем Высшей Силе, прося о"
    " прощении и избавлении.</i>\n\n"
    "🙏 <b>Спокойной ночи!</b>"
)
...
MORNING_PRAYER_TEXT_KK = (
    ...
    "<i>«Құдайым, ойымды дұрыс арнаға бағытта, өзімді аяудан, арсыз"
    " әрекеттерден, дүниеқоңыздықтан сақта».</i>\n\n"
    "2. Таңертең <b>алдағы күн туралы ойлану керек.</b>\n\n"
    "3. Алдағы күн туралы ойлана отырып... Егер сенімсіздік болса, -"
    " <b>дұға:</b>\n"
    "<i>«Құдайым, маған шабыт, интуитивті ойлар немесе шешімдер бер».</i>\n\n"
    "4. <b>Медитацияға терең бойлаймыз.</b>\n"
    "<i>«Құдайым, келесі қадамым қандай болу керектігін ашып көрсет, және"
    " мәселелерімізді шешуге қажеттінің бәрін бер. Мені өз білімділігімнен"
    " азат ет».</i>\n\n"
...
EVENING_PRAYER_TEXT_KK = (
    ...
    "1. Мен бүгін эгоист болдым ба? Әділетсіз болдым ба? Ашуландым ба?"
    " Қорқынышты сездім бе?\n"
    ...
    "<i>Содан кейін бәрін кешіреміз, ал өз қателіктерімізді Жоғары Күшке"
    " тапсырып, кешірім мен құтқаруды сұраймыз.</i>\n\n"
    "🙏 <b>Қайырлы түн!</b>"
)
