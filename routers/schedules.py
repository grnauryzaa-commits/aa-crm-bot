...
SCHEDULE_TEXTS = {
    ...
    "kk": {
        ...
        "tim": (
            "🏢 <b>Тимирязев көшесі, 42, 23-корпус, 102-каб.</b>\n\n• <b>Друзья"
            " Билла</b>: Сей, Бей 12:00\n• <b>Наурыз</b>: Сей, Бей, Жұм, Сен 19:00,"
            " Жек 15:00"
        ),
        "kaskelen": (
            "🏢 <b>«Нұр-Жанат» СҮ (Қаскелен қ.)</b>\n\n• <b>«Тұран» тобы</b>: Дүй,"
            " Сәр, Сен 17:00–18:15"
        ),
        "other": (
            "📍 <b>Басқа орындар</b>\n\n• <b>Ақсай</b> (Райымбек даңғылы 493): Жек"
            " 13:00\n• <b>НОВЫЕ ОЧКИ</b> (Жібек Жолы көшесі 64): Дүй, Сәр, Жұм 19:00,"
            " Сен 14:00\n• <b>Боралдай</b> (Курчатов көшесі 13а): Сен 17:00\n•"
            " <b>Талхиз (Талғар)</b> (Мұратбаев көшесі 26): Дүй, Бей, Жұм"
            " 19:00\n\n• <b>Турксиб</b>: +77478601105 арқылы нақтылау\nУақыты: Сей,"
            " Бей 19:00-20:30; Жек 17:00-18:30"
        ),
        "btn_online": "🌐 Онлайн топтар",
        "btn_zhub": "📍 Алматы: Жұбанов 3а",
        "btn_zenk": "📍 Алматы: Зенков 24",
        "btn_tim": "📍 Алматы: Тимирязев 42",
