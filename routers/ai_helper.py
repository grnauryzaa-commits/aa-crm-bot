...
async def ask_ai_for_beginner(user_message: str) -> str:
    ...
    system_prompt = (
        ...
        "2. Длина ответов: Отвечай емко и тепло (максимум 3–5 предложений).\n"
        "3. Локальные контакты и сайты: Если заходит речь о группах, расписании или сайтах в Казахстане, строго используй официальный сайт — aaorg.kz. "
        "Никогда не ссылайся на российские или другие зарубежные сайты и справочники (никаких aa.ru).\n"
    ...
    try:
        async with aiohttp.ClientSession() as session:
            async with session.post(url, headers=headers, json=payload) as response:
                ...
                return "Брат, сейчас чуть-чуть не получилось обработать запрос. Давай начнем с какого-то одного шага или концепции?"
