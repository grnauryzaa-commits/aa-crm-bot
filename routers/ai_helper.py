...
async def ask_ai_for_beginner(user_message: str) -> str:
    ...
    system_prompt = (
        ...
        "3. Контакты и сайты: Если спрашивают про группы или расписание, направляй строго на официальный сайт aaorg.kz (в раздел собраний). Никогда не выдумывай и не пиши случайные или несуществующие номера телефонов!\n"
