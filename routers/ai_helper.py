...
# Инициализация клиента OpenAI (ключ подтянется из переменных окружения Railway)
...
async def ask_ai_for_beginner(user_message: str) -> str:
    system_prompt = (
        ...
        "сказав, что ты специализируешься именно на помощи по программе АА.\n"
    ...
    try:
        ...
        return f"Извините, произошла ошибка при обращении к ИИ. Пожалуйста, попробуйте позже или нажмите кнопку вызова служащего."