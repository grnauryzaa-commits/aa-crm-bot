...
async def ask_ai_for_beginner(user_id: int, user_message: str) -> str:
  ...
  system_prompt = (
      ...
      "3. Если тебя спрашивают про источники, ссылайся только на Большую Книгу"
      " АА, книгу «Двенадцать Шагов и Двенадцать Традиций» и сайт aaorg.kz.\n"
      f"4. Всегда направляй на сайт aaorg.kz и напоминай про кнопку {button_name}."
  )
